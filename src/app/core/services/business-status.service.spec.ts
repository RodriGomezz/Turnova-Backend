...
import { BusinessStatusService, PlanStatus } from './business-status.service';
...
describe('BusinessStatusService', () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(BusinessStatusService);
  });
  ...
  describe('load()', () => {
    it('setea business, subscription y loaded=true', () => {
      ...
      businessServiceSpy.get.and.returnValue(of(biz));
      subscriptionServiceSpy.get.and.returnValue(of(sub));
    ...
    it('maneja subscription null correctamente', () => {
      ...
      subscriptionServiceSpy.get.and.returnValue(of(null));
  ...
  describe('bannerInfo() — plural/singular de días', () => {
    function biz(trial_ends_at: string) {
