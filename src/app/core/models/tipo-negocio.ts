export interface TipoNegocio {
  value: string;
  label: string;
  svgPath: string; // path del SVG en lugar de emoji
...
export const TIPOS_NEGOCIO: TipoNegocio[] = [
  {
    ...
    label: 'Barbería',
    svgPath:
      'M6 2v4m0 0a2 2 0 1 0 4 0M6 6a2 2 0 1 1 4 0m0 0v14M6 20v-4m0 0a2 2 0 1 1 4 0m-4 0a2 2 0 1 0 4 0M18 2l-4 10 4 10',
  ...
  },
  {
    ...
    label: 'Peluquería',
    svgPath:
      'M7.5 3.375c0-1.036.84-1.875 1.875-1.875h.375a3.75 3.75 0 0 1 3.75 3.75v1.875C13.5 8.161 14.34 9 15.375 9h1.875A3.75 3.75 0 0 1 21 12.75v3.75a1.875 1.875 0 0 1-1.875 1.875H4.875A1.875 1.875 0 0 1 3 16.5v-9A1.875 1.875 0 0 1 4.875 5.625h.375',
  ...
  },
  {
    ...
    label: 'Spa / Estética',
    svgPath:
      'M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446A9 9 0 1 1 12 2.999z M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0zM4.501 20.118a7.5 7.5 0 0 1 14.998 0',
