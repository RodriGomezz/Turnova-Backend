    ...
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <!-- HEADER (rojo apagado: distingue urgencia sin romper la paleta de marca) -->
          <tr>
          ...
          <tr>
            <td style="background:#fff;padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:13px;color:#6B7280;line-height:1.6;">
                Vamos a reintentar el cobro en los próximos días. Si el problema persiste,
                actualizá tu método de pago desde el panel.
              </p>
