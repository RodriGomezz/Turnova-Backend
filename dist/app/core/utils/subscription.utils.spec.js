...
describe('subscription.utils', () => {
    ...
    describe('calcIsPro()', () => {
        describe('plan pagado — siempre Pro independientemente del trial', () => {
            it('plan pro sin trial = Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('pro', null)).toBeTrue();
            });
            it('plan business sin trial = Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('business', null)).toBeTrue();
            });
            it('plan pro con trial vencido = Pro (plan pagado tiene prioridad)', () => {
                expect((0, subscription_utils_1.calcIsPro)('pro', '2020-01-01T00:00:00.000Z')).toBeTrue();
            });
            it('plan business con trial vencido = Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('business', '2020-01-01T00:00:00.000Z')).toBeTrue();
            });
        });
        describe('plan starter — depende del trial', () => {
            it('starter con trial vigente = Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('starter', '2099-01-01T00:00:00.000Z')).toBeTrue();
            });
            it('starter con trial vencido = no Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('starter', '2020-01-01T00:00:00.000Z')).toBeFalse();
            });
            it('starter sin trial = no Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('starter', null)).toBeFalse();
            });
            it('starter con trial que vence exactamente ahora — borde de tiempo', () => {
                ...
                expect((0, subscription_utils_1.calcIsPro)('starter', pasado)).toBeFalse();
            });
            it('starter con trial que aún no vence — futuro inmediato', () => {
                const futuro = new Date(Date.now() + 60000).toISOString();
                expect((0, subscription_utils_1.calcIsPro)('starter', futuro)).toBeTrue();
            });
        });
        describe('planes desconocidos / edge cases', () => {
            it('plan vacío con trial vigente = Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('', '2099-01-01T00:00:00.000Z')).toBeTrue();
            });
            it('plan vacío sin trial = no Pro', () => {
                expect((0, subscription_utils_1.calcIsPro)('', null)).toBeFalse();
            });
        });
    });
    // ── calcTrialDaysLeft ─────────────────────────────────────────────────────
    describe('calcTrialDaysLeft()', () => {
        it('devuelve null si no hay trial configurado', () => {
            expect((0, subscription_utils_1.calcTrialDaysLeft)(null)).toBeNull();
        });
        it('devuelve un número positivo si el trial aún no vence', () => {
            const futuro = new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString();
            const result = (0, subscription_utils_1.calcTrialDaysLeft)(futuro);
        ...
        it('devuelve número negativo o 0 si el trial ya venció', () => {
            ...
            const result = (0, subscription_utils_1.calcTrialDaysLeft)(pasado);
            expect(result).not.toBeNull();
        ...
        it('devuelve ~1 para trial que vence mañana (Math.ceil)', () => {
            ...
            const result = (0, subscription_utils_1.calcTrialDaysLeft)(manana);
...
//# sourceMappingURL=subscription.utils.spec.js.map