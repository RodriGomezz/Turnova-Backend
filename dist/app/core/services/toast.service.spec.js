...
describe('ToastService', () => {
    ...
    describe('show()', () => {
        ...
        it('remueve el toast automáticamente tras la duración (default 3500ms)', (0, testing_1.fakeAsync)(() => {
            service.show('auto-remove');
            expect(service.toasts().length).toBe(1);
            (0, testing_1.tick)(3500);
            expect(service.toasts().length).toBe(0);
        }));
        it('remueve el toast en la duración personalizada', (0, testing_1.fakeAsync)(() => {
            service.show('custom', 'info', 1000);
            (0, testing_1.tick)(999);
            expect(service.toasts().length).toBe(1);
            (0, testing_1.tick)(1);
            expect(service.toasts().length).toBe(0);
        }));
        it('no remueve otros toasts al remover uno', (0, testing_1.fakeAsync)(() => {
    ...
    describe('error()', () => {
        ...
        it('usa duración de 5000ms para errores', (0, testing_1.fakeAsync)(() => {
            service.error('Error persistente');
            (0, testing_1.tick)(4999);
            expect(service.toasts().length).toBe(1);
            (0, testing_1.tick)(1);
            expect(service.toasts().length).toBe(0);
        }));
